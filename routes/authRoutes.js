...
//   process.env.JWT_SECRET_ACCESS,function(err,decoded){
//     if(decoded.role=="student"){
//       res.send("you don't have a accessToken")
//     }else{
//       next()
//     }
//   }
...
// }
// router.get("/privatedata",abc,(req,res)=>{
...
router.post("/login2",loginController)
